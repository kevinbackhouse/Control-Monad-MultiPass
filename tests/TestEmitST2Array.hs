...
module TestEmitST2Array ( instanceTest ) where
...
instanceTestBody1 :: TestInstrument3 (EmitST2Array Int a r w) r w
instanceTestBody1 = testInstrument3

instanceTest2 :: ST2 r w ()
instanceTest2 = run instanceTestBody2

instanceTestBody2 :: TestInstrument3 (EmitST2Array Integer a r w) r w
